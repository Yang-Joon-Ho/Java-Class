				...
				<form class="needs-validation" action="application.do" method = "post" novalidate>
					...
					<div class="mb-3">
						<label for="account">Account</label> <input type="text" name="account"
							class="form-control" id="account" placeholder="계좌 번호"
							required>
						<div class="invalid-feedback">Please enter your shipping
							address.</div>
					</div>
					...
					<div class="mb-3">
						<label for="amount">Amount</label> <input type="text" name="amount"
							class="form-control" id="amount" placeholder="신청 금액"
							required>
						<div class="invalid-feedback">Please enter your shipping
							address.</div>
					</div>
					...
					<div class="mb-3">
						<label for="company">Company</label> <input type="text" name="company"
							class="form-control" id="company" placeholder="회사명"
							required>
						<div class="invalid-feedback">Please enter your shipping
							address.</div>
					</div>
					<div class="mb-3">
						<label for="license">license number</label> <input type="text" name="license"
							class="form-control" id="license" placeholder="사업자등록번호"
							required>
						<div class="invalid-feedback">Please enter your shipping
							address.</div>
					</div>
