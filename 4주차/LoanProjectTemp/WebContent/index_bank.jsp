	...
	<div class="container">
		<header class="blog-header py-3">
			<div
				...
				<div class="col-4 d-flex justify-content-end align-items-center">
					...
					<a class="btn btn-sm btn-outline-secondary" href="login_choice.jsp">Sign up</a>
		...
		<div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
			<div class="col-md-6 px-0">
				<h1 class="display-4 font-italic">은행 메인 페이지</h1>
			...
			<div class="col-md-6">
				<div
					...
					<div class="col p-4 d-flex flex-column position-static">
						...
						<h3 class="mb-0">대출자 신청서 관리</h3>
						<div class="mb-1 text-muted">Nov 12</div>
						<p class="card-text mb-auto">This is a wider card with
							supporting text below as a natural lead-in to additional content.</p>
						<a href="application_list.do?bank=${bank}" class="stretched-link">Continue
							reading</a>
					</div>
