	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8 order-md-1">
				...
				<form class="needs-validation" action="user_update.do" method = "post" novalidate>
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="id">Id</label> <input type="text"
								class="form-control" name="id" id="id" placeholder="${myPage.id }" value="${myPage.id }"
								required>
						 ...
						 <div class="col-md-6 mb-3">
            			     ...
            			     <input type="text" class="form-control" name="password" id="password" placeholder="${myPage.pw }" value="${myPage.pw }" required>
					...
					<div class="mb-3">
						...
						<div class="input-group">
							...
							<input type="text" name="name" class="form-control" id="name"
								placeholder="${myPage.name }" value="${myPage.name }" required readonly>
					...
					<div class="mb-3">
						...
						<input type="email" class="form-control" name="email" id="email"
							value="${myPage.eMail }" placeholder="${myPage.eMail }">
					...
					<div class="mb-3">
						<label for="address">Address</label> <input type="text" name="address"
							class="form-control" id="address" placeholder="${myPage.address }"
							value="${myPage.address}" required>
					...
					<div class="mb-3">
						<label for="account">Account</label> <input type="text" name="account"
							class="form-control" id="account" placeholder="${myPage.account }"
							value="${myPage.account }"required>
						<div class="invalid-feedback">Please enter your shipping
							address.</div>
					</div>
					...
					<div class="mb-3">
						<label for="amount">Amount</label> <input type="text" name="amount"
							class="form-control" id="amount" placeholder="${myPage.amount }"
							value="${myPage.amount }" required>
						<div class="invalid-feedback">Please enter your shipping
							address.</div>
					</div>
					...
					<a href="withdrawal.do?id=${myPage.id }" class="btn btn-primary btn-lg btn-block">회원탈퇴</a>
				</form>
			</div>
		</div>
