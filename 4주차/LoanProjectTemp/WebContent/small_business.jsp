...
<body>
	...
	<section class="jumbotron text-center">
		<div class="container">
			<h1>소상공인 안내</h1>
			<p class="lead text-muted">가나다라</p>
			<p>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card mb-4 shadow-sm">
						...
						<div class="card-body">
							<p class="card-text">1. 지원대상 : 모든 소상공인(1차 프로그램 수혜자 제외)<br/>
							2. 대출금리 : (중신용등급기준) 연 3~4% 수준</p>
							<div class="d-flex justify-content-between align-items-center">
								<div class="btn-group">
									<button type="button" onClick="javascript:window.location='application_ready.do?id=${id}'" class="btn btn-sm btn-outline-secondary">신청하기</button>
								</div>
