...
<body>
	<form action = "modifyOk.jsp" method="post" name="reg_frm">
		아이디 : <%= dto.getId() %> <br/>
		비밀번호 : <input ype="password" name ="pw" size = "20"><br/>
		...
		<input type = "button" value="수행" onClick="updateInfoConfirm()">&nbsp; <input type="reset" value="취소" onClick="javascript:window.location='login.jsp'">
	</form>
